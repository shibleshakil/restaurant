                                        ...
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-4 ">
                                                    ...
                                                    <input type="text" id="item" class="form-control" placeholder="Item Name" name="item" value="" required>
                                                </div>

                                                <div class="form-group col-md-4 ">
                                                    <label for="price">Item Price</label>
                                                    <input type="number" id="price" class="form-control" placeholder="Item Price" name="price" value="" required>
                                                </div>
                                                <div class="form-group col-md-4 ">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a data-toggle="modal"data-target="#editItem" data-target-id="{{$item->id}}"
                                                           data-item="{{$item->item}}" data-price="{{$item->price}}" data-description="{{$item->description}}" >
