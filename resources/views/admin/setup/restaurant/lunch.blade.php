...
<div class="content-wrapper">
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-1">
            <h3 class="content-header-title">
                <a href="{{ route ('restaurant.index')}}" class="btn btn-primary">Back to List<i
                        class="fa fa-eye"></i></a>
            </h3>
        </div>
    ...
    <div class="content-body">
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body">
                                <form class="form" method="post" action="{{ route('restaurant.lunch',$data->id) }}"
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-4 ">
                                                ...
                                                <input type="text" id="name" class="form-control"
                                                    placeholder="Restaurant Name" name="name" value="{{$data->name}}"
                                                    readonly>
                                            </div>
        ...
        <!-- Start Add Modal -->
        <div class="modal fade text-left" id="editItem" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35"
            aria-hidden="true">
                    ...
                    <form action="{{ route ('restaurantLunchItem.update')}}" method="post" class="clearForm form"
                        ...
                        <div class="modal-body">
                            ...
                            <fieldset class="form-group floating-label-form-group">
                                ...
                                <input type="text" name="item" class="form-control" id="eitem" placeholder="Item Name"
                                    required>
                            </fieldset>
                            <fieldset class="form-group floating-label-form-group">
