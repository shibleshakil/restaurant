...
<head>
    ...
    <link href="{{ asset('assets/css/color.php?primary_color=').str_replace('#','',$gsetting->primary_color) }}"
        rel="stylesheet">
    <link href="{{ asset('assets/css/color.php?primary_bg_color=').str_replace('#','',$gsetting->primary_bg_color) }}"
        rel="stylesheet">
    <style>
    .menu-img1 {
